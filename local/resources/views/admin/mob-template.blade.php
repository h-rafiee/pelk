...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="col-sm-12">
                <h2>
                    {!! trans('admin.mobile').' | '.trans('admin.home-template') !!}
                </h2>
                <hr>
                ...
                @endif
                {{--END MESSAGES--}}
                <form action="{{url('admin/mobile/template')}}" onsubmit="return dosubmit()" method="post" class="form" enctype="multipart/form-data">
                {{csrf_field()}}
                <div class="col-md-8">
                    <div class="well ">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        <p>
                            <a href="javascript:void(0)" data-item="categories" data-banner="no" class="addItem btn btn-default"><i class="fa fa-plus"></i> دسته بندی</a>
                            <a href="javascript:void(0)" data-item="tags" data-banner="no" class="addItem btn btn-default"><i class="fa fa-plus"></i> تگ</a>
                        </p>
                        <p>
                            <a href="javascript:void(0)" data-item="publications" data-banner="no" class="addItem btn btn-default"><i class="fa fa-plus"></i> ناشر</a>
                            <a href="javascript:void(0)" data-item="writers" data-banner="no"  class="addItem btn btn-default"><i class="fa fa-plus"></i> نویسنده</a>
                            <a href="javascript:void(0)" data-item="translators" data-banner="no" class="addItem btn btn-default"><i class="fa fa-plus"></i> مترجم</a>
                        </p>
                        <hr>
                        <p>
                            <a href="javascript:void(0)" data-item="categories" data-banner="has"  class="addItem btn btn-default"><i class="fa fa-plus"></i> بنر دسته بندی</a>
                            <a href="javascript:void(0)" data-item="tags" data-banner="has"  class="addItem btn btn-default"><i class="fa fa-plus"></i> بنر تگ</a>
                        </p>
                        <p>
                            <a href="javascript:void(0)" data-item="publications" data-banner="has" class="addItem btn btn-default"><i class="fa fa-plus"></i> بنر ناشر</a>
                            <a href="javascript:void(0)" data-item="writers" data-banner="has"  class="addItem btn btn-default"><i class="fa fa-plus"></i> بنر نویسنده</a>
                            <a href="javascript:void(0)" data-item="translators" data-banner="has" class="addItem btn btn-default"><i class="fa fa-plus"></i> بنر مترجم</a>
                        </p>
                        {{--<p>--}}
