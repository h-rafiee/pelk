    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <h1>{!! trans('admin.magazines') !!}</h1>
                <a href="magazines/create"><span
                            class="fa fa-file-o"></span> {!! trans('global.create_new',['name'=>trans('admin.magazine')]) !!}
                </a>
            </div>
        </div>
    </div>
                    ...
                    <tbody class="tahoma">
                        ...
                        @foreach($model as $value)
                            <tr id="rowID{{$value->id}}">
                                ...
                                <td><a href="{{url("admin/magazines/{$value->id}/edit")}}" class="text-warning"><span
                                ...
                                <td><a class="remove confirm text-danger" href="javascript.void(0)"
                                       ...
                                       data-link="{{url("admin/magazines/{$value->id}")}}"><span
