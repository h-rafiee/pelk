...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                ...
                <a href="users/create"><span
                            class="fa fa-file-o"></span> {!! trans('global.create_new',['name'=>trans('admin.user')]) !!}
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-lg-12">
                ...
                <table width="100%" class="table table-striped table-bordered table-hover dataTable">
                    ...
                    @foreach($model as $value)
                        <tr id="rowID{{$value->id}}">
                            ...
                            <td><a href="{{url("admin/users/{$value->id}/edit")}}" class="text-warning"><span
                            ...
                            <td><a class="remove confirm text-danger" href="javascript.void(0)"
                                   ...
                                   data-link="{{url("admin/users/{$value->id}")}}"><span
            ...
            @else
                <div class="panel">
                    <h3 class="text-center">{!! trans('admin.non_item_found') !!}</h3>
                </div>
            @endif
        </div>
    </div>
