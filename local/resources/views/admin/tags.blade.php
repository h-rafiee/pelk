    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="page-header">
                <h1>{!! trans('admin.tags') !!}</h1>
                <a href="tags/create"><span
                            class="fa fa-file-o"></span> {!! trans('global.create_new',['name'=>trans('admin.tag')]) !!}
                </a>
            </div>
        </div>
    </div>
                ...
                <table width="100%" class="table table-striped table-bordered table-hover dataTable">
                    ...
                    @foreach($model as $value)
                        <tr id="rowID{{$value->id}}">
                            ...
                            <td><a href="{{url("admin/tags/{$value->id}/edit")}}" class="text-warning"><span
                            ...
                            <td><a class="remove confirm text-danger" href="javascript.void(0)"
                                   ...
                                   data-title="{!! trans('admin.confirm_delete',['val'=>$value->value]) !!}"
                                   data-link="{{url("admin/tags/{$value->id}")}}"><span
